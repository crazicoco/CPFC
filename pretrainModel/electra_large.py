...
class preTrainElectraSimple(torch.nn.Module):
    def __init__(self, preTrainModel, labelNums):
        super(preTrainElectraSimple, self).__init__()
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, ocemotionSerial, ocnliSerial, tnewsSerial):
        output = self.preTrainModel(input_ids, token_type_ids, attention_mask)['last_hidden_state']
